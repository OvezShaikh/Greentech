...
function Login() {
  ...
  useEffect(()=>{
    JSON.parse(localStorage.getItem('auth'))?.token && navigate('/')
  }, [])
            ...
            <div className="p-4 md:p-5">
              <form className="space-y-4" action="#" onSubmit={formik.handleSubmit}>
                ...
                <div className="flex justify-end">
                  ...
                  <Link to="/ForgetPassword" className="text-sm text-blue-700 hover:underline dark:text-blue-500">Forgate Password?</Link>
                </div>
